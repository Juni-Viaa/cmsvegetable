        ...
        <form action="{{ route('settings.profile.update') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="first_name"
                            value="{{ old('first_name', $user->first_name ?? 'First') }}" placeholder="First"
                    ...
                    <div>
                        ...
                        <input type="text" name="last_name" value="{{ old('last_name', $user->last_name ?? 'Last') }}"
                            placeholder="Last"
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <input type="text" name="username" value="{{ old('username', $user->username ?? 'Username') }}"
            ...
            <div class="mb-8">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" value="{{ old('phone', $user->phone ?? '+62 1234-5678-9000') }}"
