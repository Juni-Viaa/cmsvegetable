<div class="w-64 bg-white rounded-lg shadow-sm p-6">
    ...
    <nav class="space-y-2">
        <a href="{{ route('settings.index') }}"
            ...
            <div
                class="w-6 h-6 border-2 {{ request()->routeIs('settings.index') ? 'border-white' : 'border-gray-400' }} rounded flex items-center justify-center">
        ...
        <a href="{{ route('settings.password') }}"
            ...
            <div
                class="w-6 h-6 border-2 {{ request()->routeIs('settings.password') ? 'border-white' : 'border-gray-400' }} rounded flex items-center justify-center">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
