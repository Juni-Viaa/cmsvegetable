        ...
        <div class="max-w-6xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-md flex flex-col md:flex-row overflow-hidden">
                <img src="{{ asset('storage/' . $product->image_path) }}" alt="{{ $product->name }}"
                    class="md:w-1/3 w-full object-cover h-64 md:h-auto">
                <div class="p-6 flex-1 space-y-3">
                    <h2 class="text-xl font-bold">{{ $product->name }}</h2>
                    <div class="flex justify-between text-sm text-gray-600">
                        <span
                            class="bg-gray-200 px-2 py-1 rounded-md">{{ $product->category->category_name ?? 'Kategori' }}</span>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-md p-6 space-y-6">
                        ...
                        <form id="commentForm" method="POST"
                            action="{{ url('/products/' . $product->product_id . '/comment') }}" class="mt-6"
