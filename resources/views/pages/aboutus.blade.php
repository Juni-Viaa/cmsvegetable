...
@section('content')
    <main class="w-full px-4 md:px-16 lg:px-24 py-12 space-y-16">
        ...
        <div class="relative rounded-xl overflow-hidden shadow-2xl">
            <div class="relative h-[28rem] parallax-banner"
                style="background-image: url('{{ asset('images/sayur1.jpg') }}');">
                <div class="absolute inset-0 bg-black/50 z-10"></div>
                <div
                    class="absolute bottom-8 left-8 z-20 text-white text-4xl md:text-5xl font-bold drop-shadow-xl animate-glow">
        ...
        <section class="text-center max-w-5xl mx-auto space-y-6" data-reveal>
            ...
            <p class="text-gray-600 text-base">
                Sayur Kita is a web-based CMS platform designed to support the export of Indonesia’s finest locally-grown
                vegetables...
            </p>
            <p class="text-gray-600 text-base">
        ...
        <section class="grid md:grid-cols-2 gap-10" data-reveal>
            <div
                class="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-green-200 transition duration-300 ease-in-out">
        ...
        <section class="grid md:grid-cols-3 gap-10" data-reveal>
            @foreach ([['src' => 'petani lokal.jpg', 'label' => 'Local Farmer'], ['src' => 'distribusi cepat.png', 'label' => 'Fast Distribution'], ['src' => 'kualitas terbaik.png', 'label' => 'Best Quality']] as $item)
                <div
                    class="bg-white rounded-xl shadow-md p-6 text-center transform hover:scale-105 transition duration-300 hover:shadow-xl">
                    <img src="{{ asset('images/' . $item['src']) }}" alt="{{ $item['label'] }}"
        ...
        <section class="text-center space-y-8" data-reveal>
            ...
            <div class="flex flex-wrap justify-center gap-10 max-w-4xl mx-auto">
                @foreach ([['src' => 'yeni rokhayati.jpg', 'name' => 'Yeni Rokhayati, S.Si., M.Sc', 'title' => 'Head of Informatics Engineering Program'], ['src' => 'agung riyadi.jpg', 'name' => 'Agung Riyadi, S.Si., M.Kom', 'title' => 'Project Manager']] as $person)
                    <div
                        class="bg-white p-6 rounded-2xl shadow-lg max-w-xs transform hover:scale-105 transition duration-300">
                        <img src="{{ asset('images/' . $person['src']) }}"
