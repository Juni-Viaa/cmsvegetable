        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col">
                ...
                @forelse($data as $index => $row)
                    <!-- Baris Data -->
                    <div class="item-card flex flex-row items-center justify-between border-b border-gray-300 py-4 px-2">
                        ...
                        <!-- Kolom: Nama Kategori -->
                        <div class="flex flex-col w-4/12 pr-4 border-r border-gray-300">
                            <h3 class="text-indigo-950 text-xl font-bold break-words">{{ $row->category_name }}</h3>
                        </div>

                        <!-- Kolom: Tipe Kategori -->
                        <div class="hidden md:flex flex-col w-4/12 pr-4 border-r border-gray-300">
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $row->category_type }}</h3>
                        </div>

                        <!-- Kolom: Tombol Aksi -->
                        <div class="hidden md:flex flex-row items-center justify-center w-2/12 pr-4 gap-x-2">
